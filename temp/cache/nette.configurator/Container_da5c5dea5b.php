<?php
// source: /home/david/github-classroom/ossp-cz/Nette/config/common.neon
// source: /home/david/github-classroom/ossp-cz/Nette/config/services.neon
// source: array
...
class Container_da5c5dea5b extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\UI\Sign\SignPresenter' => [2 => ['application.6']],
	...
	{
		$service = new App\UI\Edit\EditPresenter($this->getService('01'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__6(): App\UI\Sign\SignPresenter
	{
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'/home/david/github-classroom/ossp-cz/Nette/temp/cache/nette.application/touch',
		));
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_da5c5dea5b $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/home/david/github-classroom/ossp-cz/Nette/temp/cache/latte');
